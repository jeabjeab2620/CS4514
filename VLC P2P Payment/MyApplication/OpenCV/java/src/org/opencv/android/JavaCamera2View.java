                ...
                new CameraCaptureSession.StateCallback() {
                    ...
                    public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        ...
                        try {
                            ...
                            //Range<Integer> fpsRange = fpsRanges[0];
                            /*for (Range<Integer> range : fpsRanges) {
                                Log.d("Camera FPS Setting", String.valueOf(range.getUpper()));
                                Log.d("Camera FPS Setting", String.valueOf(range.getLower()));
                            ...
                            long exposureTime = 1000000000L / FPS; // 1 second divided by desired FPS
                            Range<Long> exposureRange = characteristics.get(CameraCharacteristics.SENSOR_INFO_EXPOSURE_TIME_RANGE);
                            if (exposureTime < exposureRange.getLower()) {
                                exposureTime = exposureRange.getLower();
                            } else if (exposureTime > exposureRange.getUpper()) {
                                exposureTime = exposureRange.getUpper();
                            }
